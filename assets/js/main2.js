!(function (e) {
  "use strict";
  var a = e(".rt-date");
  a.length && a.datetimepicker({ format: "Y-m-d", timepicker: !1 });
  var t = e(".rt-time");
  function n() {
  ...
  function o() {
    var a = e(".header-height-wrap"),
      ...
      o = a.outerHeight();
    t < 992 && (o = e("body > .mean-bar").outerHeight()),
      n.css("margin-top", o + "px");
  }
  t.length && t.datetimepicker({ format: "H:i", datepicker: !1 }),
    ...
    e(window).on("scroll", function () {
      n(),
        e(window).scrollTop() > 150
          ? e("#header_1").addClass("menu-sticky")
          : e("#header_1").removeClass("menu-sticky"),
        e(window).scrollTop() > 175
          ? e("#header_2").addClass("menu-sticky")
          : e("#header_2").removeClass("menu-sticky"),
        e(window).scrollTop() > 95
          ? e("#header_3").addClass("menu-sticky")
          : e("#header_3").removeClass("menu-sticky"),
        ...
        o.length
          ? (o.animate({ opacity: 0 }),
            o.promise().done(function () {
              o.removeClass("hidden"), o.show().animate({ opacity: 1 }, 1e3);
            }))
  ...
  var l = e(".counter");
  l.length && l.counterUp({ delay: 50, time: 5e3 });
  var d = e("#accordion");
  d
    ...
    e(".panel-heading a", d).on("click", function (a) {
      e(this).parents(".panel").children(".panel-collapse").hasClass("show") &&
              ...
              success: function (e) {
                ...
                if ((console.log(a), a.success))
                  ...
                  a.message.forEach(function (e) {
                    ...
                    n.html(
                      "<div class='alert alert-success'><p>" + o + "</p></div>"
                    );
                }
              },
              error: function () {
  ...
  e(".rc-carousel").each(function () {
    ...
    a.owlCarousel({
      ...
      responsiveClass: !0,
      responsive: {
        0: { items: p || 1, nav: !!u, dots: !!h },
        576: { items: m || 2, nav: !!g, dots: !!v },
        768: { items: f || 3, nav: !!w, dots: !!y },
        992: { items: k || 4, nav: !!b, dots: !!x },
        1200: { items: S || 5, nav: !!T, dots: !!C },
        1400: { items: q || 6, nav: !!H, dots: !!P },
      },
    });
    ...
    e(window).on("load", function () {
      ...
      (a = e("#slick-carousel-wrap")).length &&
        (a.find(".carousel-content").slick({
          ...
          prevArrow:
            '<span class="slick-prev slick-navigation"><i class="fa fa-angle-left" aria-hidden="true"></i></span>',
          nextArrow:
            '<span class="slick-next slick-navigation"><i class="fa fa-angle-right" aria-hidden="true"></i></span>',
        }),
        ...
        (a = e("#slick-carousel-wrap2")).length &&
          (a.find(".carousel-content").slick({
            ...
            asNavFor: ".carousel-nav",
            prevArrow:
              '<span class="slick-custom-prev slick-navigation"><i class="fas fa-chevron-left"></i></span>',
            nextArrow:
              '<span class="slick-custom-next slick-navigation"><i class="fas fa-chevron-right"></i></span>',
          }),
          a.find(".carousel-nav").slick({
            slidesToShow: 1,
            slidesToScroll: 1,
      ...
      n.length &&
        ...
        e(".popup-zoom-single").length &&
          e(".popup-zoom-single").magnificPopup({ type: "image" }),
      ...
      if (o.length)
        var i = o.imagesLoaded(function () {
          i.isotope({
            ...
            masonry: { columnWidth: ".no-equal-item" },
          });
        });
      ...
      if (
        (s.length > 0 && s.find(".isotope-classes-tab").on("click", "a", function () {
            var a = e(this);
            a.parent(".isotope-classes-tab").find("a").removeClass("current"),
              a.addClass("current");
            var t = a.attr("data-filter");
            return (
              e(".featuredContainer", s).isotope({
                filter: t,
    ...
    e(window).on("load resize", function () {
      ...
      (s -= 50),
        e(".mean-nav > ul").css("height", s + "px"),
        o(),
        (t = 0),
        (n = 0),
        (i = e(window).width()),
        e(
          ".equal-height-wrap .item-img,.equal-height-wrap .item-content"
        ).height("auto"),
        i > 991 &&
    ...
    e(window).on("scroll", function () {
      var a = e("#sticker"),
        ...
        l =
          (r.find(".header-top-bar").outerHeight(), a.prev(".header-top-bar"));
      if (i > 991) {
        t.css("padding-top", "");
        var d;
        s.length
          ...
          : r.length &&
            o <= (d = l.outerHeight()) &&
            r.hasClass("header-fixed") &&
            r.css("top", "-" + o + "px"),
          o >= d
            ? ((r.length || s.length) && a.addClass("stick"),
              r.length &&
                (r.hasClass("header-fixed")
                  ? r.css("top", "-" + d + "px")
                  : t.css("padding-top", n + "px")))
